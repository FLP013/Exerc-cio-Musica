...
Console.WriteLine(@"Da Ponte Pra Cá
Racionais MC's");
Console.ResetColor();

Console.WriteLine();

Console.WriteLine(@"Hey, hey, hey nego
...
Pro Chiquinho, pro Kau, pro Ribeiro, pro Tisso, Zulu, e o Serginho
...
E a Adriana do Tamoio manda um salve aí
Para rapa do Sujeito Suspeito do Paranapanema
...
O que toma uma taça de champanhe e também curte
Desbaratinado, tubaína tutti-frutti
Fanático, melodramático, bon-vivant
Depósito de mágoa, quem tá certo é o Saddam, ham
...
Console.ForegroundColor = ConsoleColor.Cyan;
Console.WriteLine(@"Não adianta querer, tem que ser, tem que pá
...
Console.WriteLine(@"Outra vez nóis aqui, vai vendo
...
Console.WriteLine(@"Mas não leve a mal, tru
Cê não entendeu
...
Os mano é sofrido e fuma um sem dar goela
...
Console.WriteLine(@"Três da manhã, eu vejo tudo e ninguém me vê
Subindo o campo de fora
Eu, meu parceiro Dinho, ouvindo 2Pac
Tomando um vinho, vivão e consciente
...
A rapa do morro e aos que estão com Deus
